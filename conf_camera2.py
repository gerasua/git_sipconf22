...
class updateCamera2(QDialog):
    def __init__(self, parent=None):
        super(updateCamera2, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('conf_camera2.ui', self)
        logger.debug("Ventana actualizar Camera 2")
        self.DB_Connect()
