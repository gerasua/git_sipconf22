...
class updateCamera1(QDialog):
    def __init__(self, parent=None):
        super(updateCamera1, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('conf_camera1.ui', self)
        logger.debug("Ventana actualizar Camera 1")
        self.DB_Connect()
