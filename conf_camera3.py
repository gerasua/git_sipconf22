...
class updateCamera3(QDialog):
    def __init__(self, parent=None):
        super(updateCamera3, self).__init__(parent, flags=Qt.WindowCloseButtonHint)
        loadUi('conf_camera3.ui', self)
        logger.debug("Ventana actualizar Camera 3")
        self.DB_Connect()
